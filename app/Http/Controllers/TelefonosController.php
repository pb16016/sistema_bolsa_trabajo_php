...
class TelefonosController extends Controller
{
    public function getAll()
    {
        try {
            ...
            return response()->json(['error' => 'Error al obtener los teléfonos. Detalles: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function findByNumTel()
    {
        try {
            ...
            if ($telefono) {
                ...
                return response()->json(['error' => 'Teléfono no encontrado.'], Response::HTTP_NOT_FOUND);
            }
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error al buscar teléfono. Detalles: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['message' => 'Teléfono creado exitosamente.', 'data' => $telefono], Response::HTTP_CREATED);

        } catch (ValidationException $e) {
            return response()->json(['error' => 'Error de validación al crear el Telefono. Detalles: ' . $e->errors()], 422);
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error al crear el teléfono. Detalles: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function update(Request $request, $numTelefono)
    {
        try {
            ...
            return response()->json(['error' => 'Teléfono no encontrada. Detalles: ' . $e->getMessage()], Response::HTTP_NOT_FOUND);
        } catch (ValidationException $e) {
            return response()->json(['error' => 'Error de validación al actualizar el Teléfono. Detalles: ' . $e->errors()], 422);
        } catch (\Exception $e) {
            return response()->json(['error' => 'Error al actualizar el teléfono. Detalles: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function destroy($numTelefono)
    {
        try {
            ...
            return response()->json(['error' => 'Error al eliminar el teléfono. Detalles: ' . $e->getMessage()], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
}
